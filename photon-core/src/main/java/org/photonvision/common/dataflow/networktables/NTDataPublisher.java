        ...
        if(pidgey.isConnected()) {
            ...
            if(estimatedPose.isPresent()) {
                ...
                trig_ts.targetPoseEntry.set(new Transform3d(
                    roboPose.estimatedPose.getTranslation(),
                    roboPose.estimatedPose.getRotation()
                ));
